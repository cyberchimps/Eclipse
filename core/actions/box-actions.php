...
function response_box_section_content() { 
	...
	if (is_page()) {
		...
		$title = $options->get($themeslug.'_blog_box_title');
		$toggle = $options->get($themeslug.'_blog_box_title_toggle');	
	} 
?>
<div class="container">
<div class="row">
	...
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Box 1") ) : ?>
		<div id="box1" class="three columns">
			...
			<h2 class="box-widget-title">Responsive Design</h2>	
				<p class="boxtext">
					Eclipse’s Modern Responsive Design automatically adjusts to any mobile device including the iPhone, iPad, and Android devices.
				</p>
			</div><!--end box1-->
		<?php endif; ?>
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Box 2") ) : ?>
		<div id="box2" class="three columns">
			...
			<h2 class="box-widget-title">Content Feature Slider </h2>
				<p class="boxtext">
					Eclipse comes with a SEO and iOS friendly Responsive Content Feature Slider that displays content professionally and beautifully on any device.
				</p>
		</div><!--end box2-->
		<?php endif; ?>
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Box 3") ) : ?>
		<div id="box3" class="three columns">
			...
			<h2 class="box-widget-title">Drag and Drop Elements</h2>
				<p class="boxtext">
					Eclipse includes a variety of Drag and Drop Page Elements make mananaging content easy and can be used on a per-page basis.
				</p>
		</div><!--end box3-->
		<?php endif; ?>
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Box 4") ) : ?>
		<div id="box4" class="three columns">
			...
			<h2 class="box-widget-title">Excellent Support</h2>
				<p class="boxtext">
					Eclipse is built for any response, and offers intuitive theme options. If you do run into trouble we provide a <a href="http://cyberchimps.com/forum/pro/">Support Forum</a>, and precise <a title="Eclipse Docs" href="http://cyberchimps.com/eclipse/docs/">Documentation</a>.
				</p>
		</div><!--end box3-->
		<?php endif; ?>
</div>
