...
")
	->section("Design")
		...
		->close_outersection()
			...
			->text($themeslug."_front_portfolio_image_one_caption", "First Portfolio Image Caption", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_front_portfolio_image_two_caption", "Second Portfolio Image Caption", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_front_portfolio_image_three_caption", "Third Portfolio Image Caption", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_front_portfolio_image_four_caption", "Fourth Portfolio Image caption", array('default' => 'http://cyberchimps.com'))
		...
		->subsection("Portfolio Options")
			...
			->text($themeslug."_blog_portfolio_image_one_url", "First Portfolio Image Link", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_blog_portfolio_image_two_url", "Second Portfolio Image Link", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_blog_portfolio_image_three_url", "Third Portfolio Image Link", array('default' => 'http://cyberchimps.com'))
			...
			->text($themeslug."_blog_portfolio_image_four_url", "Fourth Portfolio Image Link", array('default' => 'http://cyberchimps.com'))
			->checkbox($themeslug."_blog_portfolio_title_toggle", "Portfolio Title")
