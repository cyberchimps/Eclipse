...
")
	->section("Design")
		...
		->close_outersection()
			...
			->text($themeslug."_front_portfolio_image_one_caption", "First Portfolio Image Caption", array('default' => 'Image 1'))
			...
			->text($themeslug."_front_portfolio_image_two_caption", "Second Portfolio Image Caption", array('default' => 'Image 2'))
