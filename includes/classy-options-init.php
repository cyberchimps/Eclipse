...
")
	->section("Design")
		...
		->subsection("Menu Options")
			->select($themeslug."_menu_font", "Choose a Font", array( 'options' => array("Helvetica" => "Helvetica (default)", "Arial" => "Arial", "Courier New" => "Courier New", "Georgia" => "Georgia", "Lucida Grande" => "Lucida Grande", "Tahoma" => "Tahoma", "Times New Roman" => "Times New Roman", "Verdana" => "Verdana", "Maven+Pro" => "Maven Pro", "Ubuntu" => "Ubuntu")))			
		->subsection_end()
		->subsection("Social")
		...
		->section("Blog")
		->open_outersection()
			->section_order($themeslug."_blog_section_order", "Drag & Drop Elements", array('options' => array("response_post" => "Post Page", "response_twitterbar_section" => "Twitter Bar", "response_portfolio_element" => "Portfolio","response_box_section" => "Boxes", "response_recent_posts_element" => "Recent Posts"), "default" => 'response_portfolio_element,response_twitterbar_section,response_box_section,response_post'))
		->close_outersection()
		...
		->subsection("Portfolio Options")
			...
			->text($themeslug."_blog_portfolio_image_one_url", "First Portfolio Image Link", array('default' => 'Image 1'))
			...
			->text($themeslug."_blog_portfolio_image_two_url", "Second Portfolio Image Link", array('default' => 'Image 2'))
			...
			->text($themeslug."_blog_portfolio_image_three_url", "Third Portfolio Image Link", array('default' => 'Image 3'))
			...
			->text($themeslug."_blog_portfolio_image_four_url", "Fourth Portfolio Image Link", array('default' => 'Image 4'))
