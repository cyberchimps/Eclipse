...
")
	->section("Design")
		...
		->close_outersection()
			...
			->checkbox($ec_themeslug."_favicon_toggle", "Favicon Toggle" , array('default' => false))
		...
		->subsection("Feature Slider")
			...
			->text($ec_themeslug."_blog_slide_one_url", "Slide One Link", array('default' => 'http://cyberchimps.com'))
			->upload($ec_themeslug."_blog_slide_two_image", "Slide Two", array('default' => array('url' => TEMPLATE_URL . '/images/sliderdefault.jpg')))
			->text($ec_themeslug."_blog_slide_two_url", "Slide Two Link", array('default' => 'http://cyberchimps.com/eclipsepro'))
			->upload($ec_themeslug."_blog_slide_three_image", "Slide Three", array('default' => array('url' => TEMPLATE_URL . '/images/slide3.jpg')))
			->text($ec_themeslug."_blog_slide_three_url", "Slide Three Link", array('default' => 'http://cyberchimps.com'))
		->subsection_end()
		...
		->subsection("Portfolio Options")
			...
			->text($ec_themeslug."_blog_portfolio_image_one_caption", "First Portfolio Image Link", array('default' => 'Image 1'))
			...
			->text($ec_themeslug."_blog_portfolio_image_three_caption", "Third Portfolio Image Link", array('default' => 'Image 3'))
			...
			->text($ec_themeslug."_blog_portfolio_image_four_caption", "Fourth Portfolio Image Link", array('default' => 'Image 4'))
